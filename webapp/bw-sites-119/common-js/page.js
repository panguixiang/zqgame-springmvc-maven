 ...
 */
 var showPage2 = function(newDefaultPage) {
  ...
  function gotoPage2(currentPage) {
	  ...
	  $(defaultPagerVariable.pagerDiv).html("");
	  if(parameter != null) {
		  location.href=defaultPagerVariable.url+"/"+currentPage+"/"+defaultPagerVariable.page_size+"/"+parameter+".html";  
	  } else {
	   location.href=defaultPagerVariable.url+"/"+currentPage+"/"+defaultPagerVariable.page_size+"/tag/"+currentPage+".html"; 
	  }
  }
