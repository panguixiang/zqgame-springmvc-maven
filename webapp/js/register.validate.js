...
var validationData = {
	...
	ajaxUrl : "http://d.zqgame.com/register/quick",
	userNameRemote : "http://d.zqgame.com/register/checkname", // 异步请求校验重复性路径
	passwordId : "#passwordId",// 密码输入框Id 检测两次输入密码是否一致
	userName : "input[name='username']", // 选择通行证注册与选择邮箱注册时切换输入框内容
	autchImageId : "imagedid",
	authImageUrl:"http://d.zqgame.com/register/captcha-image?",
